...
import models.fcn.util as util

import models.common.tf_util
...
class FullyConvolutionalNetwork:
    ...
    def __init__(self, categories_count):
        ...
        self.ops_map["main_head"] = tf.keras.layers.Conv2DTranspose(
            ...
            kernel_initializer=util.bilinear_initializer)(self.ops_map["main_head"])
...
class Model:
    ...
    def __init__(self):
        ...
        self.session = tf_util.get_session()
        self.network = FullyConvolutionalNetwork(categories_count=args.n_classes)

        self.categories_count = args.n_classes
